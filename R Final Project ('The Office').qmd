...
Although lowest number of votes was `r tot_votes1` in season 1 and the highest number of votes was `r tot_votes2` in season 2, the average IMDB rating for all seasons of 'The Office' is `r total_mean`.  
